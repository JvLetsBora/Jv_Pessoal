...
const root = 'http://34.225.197.187';
var data_collect = [
...
fetch(`${root}/all`)
  ...
  .then(data => {
    ...
    data.forEach(element => {
        ...
        lista.innerHTML += `<li id="${element.id}"> <div class="titulo">${element.labels}</div> <div style="margin: 0px; color: #565656;"> ${element.x} segundos</div> <div id="tools"> <div onclick="mostrarPopup([${element.id},'${element.labels}','${element.x}'])"><img src="https://cdn-icons-png.flaticon.com/512/1827/1827933.png "></div> <div onclick="deletarNota(${element.id})"><img src="https://cdn-icons-png.flaticon.com/512/484/484611.png "></div> </div> </li>`;
  ...
  var data = {
      ...
      datasets: 
      [{
      label:'Tendência de uso por Tempo',
      data: data_collect,
      backgroundColor: ['rgb(255, 99, 132)','rgb(90, 255, 132)','rgb(105, 99, 255)','rgb(105, 105, 90)']
      }]
      };
  new Chart(ctx, {
    type: 'bubble',
